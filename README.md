...
Clanky is a coding agent manager for running, reviewing, and iterating on tasks with ACP-compatible agents such as Codex, Copilot, OpenCode, and Claude Code.
