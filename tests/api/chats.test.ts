...
describe("Chats API Integration", () => {
  ...
  test("exports chat transcript as markdown without tool call details", async () => {
    ...
    expect(standaloneHtml).not.toContain("secret-screenshot.png");
    expect(standaloneHtml).not.toContain("private-base64-data");
  ...
  test("does not persist an autogenerated chat name that arrives after timeout", async () => {
