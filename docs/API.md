...
| `issueNumber` | number | No | GitHub issue number linked to the task; automatic PR descriptions include `Closes #<issueNumber>` |
...
| `issueNumber` | number | Update the linked GitHub issue number |
