...
export function resetDatabase(): void {
  ...
  const dropAllTables = db.transaction(() => {
    ...
    db!.run("DROP TABLE IF EXISTS workspace_worker_enrollments");
    db!.run("DROP TABLE IF EXISTS mesh_worker_kill_nonces");
    ...
    db!.run("DROP TABLE IF EXISTS mesh_controller_relay_pairing");
    ...
    db!.run("DROP TABLE IF EXISTS provisioning_job_logs");
    db!.run("DROP TABLE IF EXISTS provisioning_jobs");
