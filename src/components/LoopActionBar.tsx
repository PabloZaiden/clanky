...
import { getComposerRows } from "./common";
      ...
      <form ref={composerFormRef} onSubmit={handleSubmit} className="p-3 sm:p-4">
        <div className="flex flex-row items-end gap-2 sm:gap-3">
          ...
          <textarea
            ...
            className={`${composerRows === 2 ? "min-h-[72px]" : "min-h-[44px]"} flex-1 min-w-0 resize-y text-sm px-3 py-2 rounded-md border border-gray-300 bg-white dark:border-gray-600 dark:bg-neutral-700 text-gray-900 dark:text-gray-100 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 disabled:opacity-50`}
          />
