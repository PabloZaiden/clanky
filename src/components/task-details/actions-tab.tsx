...
export function ActionsTab({
  ...
  return (
    <div
      role="region"
      aria-label="Actions"
      className={taskDetailsTabScrollContainerClassName}
    >
      <div className={`${taskDetailsTabContentFullWidthClassName} space-y-4`}>
        <div className="min-w-0 space-y-2">
          {isPlanning ? (
            <>
              <button
                onClick={() => onAcceptPlan("start_task")}
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-sm font-medium text-gray-900 dark:text-gray-100">
                    {planActionSubmitting ? "Accepting..." : "Accept Plan & Start Task"}
                  </div>
                  <div className="text-xs text-gray-500 dark:text-gray-400">
                    {isPlanReady
                      ? "Accept the plan and begin task execution"
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400">Discard this plan and delete the task</div>
                </div>
                <span className="text-gray-400 dark:text-gray-500">→</span>
              </button>
            </>
            ...
            <>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400">
                          {automaticPrFlow?.status === "stopped"
                            ? "Restart automatic monitoring so Clanky can respond to new PR feedback again."
                  ...
                  {showPullRequestAutoMerge && (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-gray-500 dark:text-gray-400">
                          {loadingPullRequestDestination
                            ? "Checking whether this task already has a GitHub pull request..."
              ...
              {canMarkMerged(state.status, Boolean(state.git)) && (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500 dark:text-gray-400">Keep this task as merged after the branch landed elsewhere</div>
                  </div>
                  <span className="text-gray-400 dark:text-gray-500">→</span>
                </button>
              )}
              {state.status === "accepted_local" && state.reviewMode?.addressable && (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-medium text-gray-900 dark:text-gray-100">Close Local Task</div>
            ...
            <>
              ...
              {canManualComplete(state.status, Boolean(state.git)) && (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-medium text-gray-900 dark:text-gray-100">Manually complete task</div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">Mark this halted task as completed so push and merge actions become available</div>
                  </div>
                  <span className="text-gray-400 dark:text-gray-500">→</span>
                </button>
              )}
