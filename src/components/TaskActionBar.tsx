/**
 * TaskActionBar component for stop/send controls and model changes.
 *
 ...
 *
 * The action bar is only visible when a task is in an active state (running, waiting, planning).
 */
...
export interface TaskActionBarProps {
  ...
  /** Whether the task is in planning mode */
  isPlanning?: boolean;
  /** Whether the task is actively generating right now */
  isGenerating?: boolean;
  /** Current model configuration (from task config) */
