...
export interface TaskCtx {
  ...
  discardTask(taskId: string): Promise<{ success: boolean; error?: string }>;
  ...
  jumpstartTask(taskId: string, options: { message?: string; model?: ModelConfig; attachments?: MessageImageAttachment[] }): Promise<{ success: boolean; error?: string }>;
}
